...
document.addEventListener('DOMContentLoaded', event => {
	...
	// Google Map on click or change filter
...
// Attach observer for lazy loading of images
lazyLoadingObserver = () => {
...
// Lazy load images once the page is rendered
...
createRestaurantHTML = restaurant => {
	...
	if (restaurant.is_favorite === true || restaurant.is_favorite === 'true') {
		favorize.setAttribute('src', '/img/icons/favorized.svg');
