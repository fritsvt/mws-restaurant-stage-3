...
class LocalState {
	...
	static toggleFavorite(mode, restaurantId) {
		...
		ApiService.fetchApiData(api, (error, data) => {
			error ? console.log(error): console.log(data.name + updated);
		});
	...
	static addReview(review) {
		...
		ApiService.fetchApiData(api, (error, data) => {
			error ? console.log(error) : console.log('Review posted.');
		});
